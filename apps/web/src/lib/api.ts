...
export const api = {
  ...
  /** Filamento à mão: mm positivo empurra, negativo retrai; mm/s tem teto no servidor. */
  extrudar: (id: string, mm: number, mmPorSegundo: number) =>
    post<{ ok: true }>(`/api/printers/${id}/extrude`, { mm, mmPorSegundo }),
